...
checkTalents:RegisterEvent('PLAYER_LOGIN')
...
local zoneDelay = function(self, elapsed)
    ...
    if (IsInInstance()) then
        ...
        if (ns.auras.instances[instanceMapID]) then
            instDebuffs = ns.auras.instances[instanceMapID]
        end
    else
        instDebuffs = {}
    end
...
getZone:RegisterEvent('PLAYER_LOGIN')
