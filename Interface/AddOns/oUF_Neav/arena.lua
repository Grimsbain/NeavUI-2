...
local function CreateArenaLayout(self, unit)
    ...
    self.Texture = self.Health:CreateTexture(nil, "ARTWORK", nil, 7)
    ...
    self.Name = self.Health:CreateFontString("$parent_Name", "ARTWORK")
    ...
    if ( self.arenaUnit ) then
        ...
        self.Health.Value:SetFont(STANDARD_TEXT_FONT, config.font.normalSize+2, nil)
        ...
        self.Power.Value:SetFont(STANDARD_TEXT_FONT, config.font.normalSize, nil)
		...
		self.CCIcon = CreateFrame("Frame", nil, self)
